...
围绕金淼原创音乐《月下星海》构建的私人互动艺术展示网站。当前已经完成从遗忘之钥、标题、星穹圣殿到核心音乐世界的体验闭环。

第一篇章已经确定为 **《月下星海》**，并接入真实原创音频与自定义 Howler.js 播放器。

星穹圣殿现定义为“东方宇宙档案馆”：远景银河、星空穹顶、古文明遗迹、环形星轨与雾层共同建立空间纵深。大厅只有三个正式入口：中心上方的“创作者档案”、左侧最大的《月下星海》月海星核，以及右侧的“音乐解析”声音星云。点击《月下星海》后按“星轨加速—粒子苏醒—月白过渡—章节标题”的顺序开启核心音乐空间。
...
星穹圣殿中心上方的金色星碑是“创作者档案”入口。点击后进入宇宙档案空间，展示金淼的作者简介、创作理念、作品方向与诗文。关闭档案时直接返回原圣殿场景，不改变相机位置和画面比例。

## 音乐解析

圣殿右侧的声音星云是《月下星海》的音乐解析入口。解析空间通过声波粒子、淡金旋律流线与光谱动画展示音乐风格、情绪表达、创作理念和听觉体验，不创建额外音乐章节。
