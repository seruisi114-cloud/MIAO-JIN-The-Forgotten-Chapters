...
星穹圣殿现定义为“东方宇宙档案馆”：远景银河、星空穹顶、古文明遗迹、环形星轨与雾层共同建立空间纵深。中央为漂浮的黑曜石/玻璃作者档案碑；第一篇章入口为程序化蓝白星球核心与香槟金星轨，第二、第三篇章为无内部光源的沉睡黑晶档案。点击《月下星海》后按“星轨加速—粒子苏醒—月白过渡—章节标题”的顺序开启篇章。

《月下星海》场景中保留一尊低透明度守护者记忆投影；正式音轨播放时，其星河光、月核、月环与粒子会温和增强，暂停后逐渐回到静息状态。
...
星穹圣殿中央的黑曜石/玻璃作者档案碑是“创作者结语”入口。碑面展示金淼、《月下星海》、创作者简介与诗文；点击后进入隐藏结语空间。关闭结语时直接返回原圣殿场景，不改变相机位置和画面比例。
